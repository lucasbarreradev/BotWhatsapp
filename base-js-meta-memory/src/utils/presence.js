...
📌 *Información sobre GymGenius*",
    "Somos una tienda online argentina especializada en equipamiento deportivo y de yoga. Ofrecemos productos premium diseñados para mejorar tu rendimiento y bienestar. Realizamos envíos rápidos y ofrecemos métodos de pago seguros.",

    "📦 *Métodos de pago y envíos*",
    "- Retiro en depósito: Ciudadela, Buenos Aires (Falucho 856, de 9hs a 16hs). Solo take away. Pagos en efectivo o transferencia al valor del carrito.",
    "- Pago en cuotas: Solo por la web.",
    "- Cotización de envíos: Consultar en https://www.correoargentino.com.ar/.",
    "- Medidas estándar de paquetes: 30x30x5 cm (para 10 bandas aprox.).",
    ...
    "- *Mat de yoga*: Base acolchada, antideslizante. Medidas: 183 cm x 61 cm x 10 mm.",
    ...
    "*Mayorista*",
    "En el siguiente link podrás ingresar al catálogo de WP para armar un carrito con tu pedido Ver la solicitud del pedido y enviarla a un vendedor: https://wa.me/c/5493537305059",

    "*Solucionar inconveniente*",
    "GymGenius ofrece garantía en todos sus productos, cubriendo cualquier defecto de fabricación o mal funcionamiento al momento de recibir tu pedido. En este caso podés devolverlo dentro de los 15 días posteriores a la recepción, siempre que el producto esté en perfectas condiciones y con su embalaje original. En esas condiciones te reembolsaremos el importe íntegro de tu compra. ¿Te gustaría hablar con nosotros? https://wa.link/yvvvrt",
    
    "*Preventa*",
    "Un nuevo pedido está por llegar. Comprá tu nuevo producto Gymgenius a precio exclusivo. Descubrilos en este link https://drive.google.com/drive/folders/1DjLxmeaQ5qZAl6S7C9Doneo5ooXjtMby?usp=sharing",
    
    "*Historia*",
    "Somos una marca que se caracteriza en vender una selección premium de equipamiento deportivo y de yoga al mejor precio del mercado, te brindamos una experiencia transformadora que elevará tu rendimiento y te permitirá encontrar el equilibrio mente-cuerpo que tanto buscás. Al ser importadores directos, podemos ser competitivos con los precios y brindar la posibilidad de distribuir los productos mediante envíos rápidos y métodos de pago confiables en nuestra tienda online y venta física. ¿Te gustaría hablar con nosotros? https://wa.link/yvvvrt",

    "🌐 *Compra online*",
    "Podés ver todos nuestros productos y precios en nuestra tienda online: https://www.gymgenius.com.ar/`;
...
- Responde en estilo conversacional y breve (menos de 300 caracteres).
